...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<link rel=\"stylesheet\" href=\"https://use.fontawesome.com/releases/v5.3.1/css/all.css\" >\n<link href=\"//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css\" rel=\"stylesheet\">\n<router-outlet></router-outlet>";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardContactContactComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardPariculatContactsPariculatContactsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dashboard_contact_contact_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./dashboard/contact/contact.component */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_8__["DashboardModule"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_13__["ToastrModule"].forRoot(), ng2_search_filter__WEBPACK_IMPORTED_MODULE_10__["Ng2SearchPipeModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot([{
        path: 'Dashboard',
        component: _dashboard_contact_contact_component__WEBPACK_IMPORTED_MODULE_9__["ContactComponent"]
      }, {
        path: '',
  ...
  /***/
  function srcAppDashboardContactContactComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDashboardContactContactComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_socket_contact_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/socket-contact.service */
    ...
    var dropbox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! dropbox */
    "./node_modules/dropbox/dist/Dropbox-sdk.min.js");
    /* harmony import */


    var dropbox__WEBPACK_IMPORTED_MODULE_5___default =
    /*#__PURE__*/
    __webpack_require__.n(dropbox__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    var dbx = new dropbox__WEBPACK_IMPORTED_MODULE_5__["Dropbox"]({
      accessToken: '8OFJNocMFEAAAAAAAAAAhPJetJappwjmhdqNUT5izThN7PRcKdTA27CM6kt3-r_n',
      fetch: fetch
    });
    ...
    /*#__PURE__*/
    function () {
      function ContactComponent(toastr, domSanitizer, _router, socket_service) {
        var _this = this;
        ...
        this.getAllContacts = function (default_image_url_passed) {
          _this.Contacts = [];

          _this.socket_service.get_all_contacts().subscribe(function (apiResponse) {
            ...
            try {
              var _loop = function _loop() {
                var x_contacts = _step.value;
                _this.counter++;

                if (x_contacts['image'] != null) {
                  file_ext1 = x_contacts['image'].split('.').pop();
                  file_ext = file_ext1.toLowerCase();
                  ...
                  if (file_ext == 'bmp' || file_ext == 'gif' || file_ext == 'ico' || file_ext == 'jpeg' || file_ext == 'jpg' || file_ext == 'png' || file_ext == 'svg' || file_ext == 'tiff' || file_ext == 'tif' || file_ext == 'webp') {
                    dbx.filesGetThumbnail({
                      "path": "/contact_Manage/".concat(x_contacts['image']),
                      format: {
                        '.tag': 'jpeg'
                      },
                      size: {
                  ...
                  default_url = default_image_url_passed;
                }

                var getUrl = function getUrl(url_of_img, contactid) {
                  c_image_url = url_of_img;
                  jquery__WEBPACK_IMPORTED_MODULE_4__('#attchament_img_display' + contactid).attr('src', url_of_img);
                };

                _this.Contacts = [].concat(_toConsumableArray(_this.Contacts), [{
        ...
        this.OnFileSelected = function (event) {
          ...
          _this.import_contacts = event.target.files[0];
        };

        this.upload_data = function () {
          if (_this.import_contacts != undefined || _this.import_contacts != null) {
            var contact_file_path = jquery__WEBPACK_IMPORTED_MODULE_4__('#blah').attr('src');
            var import_contacts_data = {
              import_contacts: _this.import_contacts,
              import_contacts_name: _this.import_contacts.name,
              import_contacts_type: _this.import_contacts.type,
              import_contacts_path: contact_file_path
            };

            if (_this.import_contacts.type.toLowerCase() == 'application/json') {
              _this.socket_service.import_contacts(import_contacts_data);
            } else {
              _this.toastr.error("Only Json File Is Allowed To Import Contacrs!!");
            }
          }
        };

        this.get_contacts_from_all_users = function () {
          _this.socket_service.get_all_contacts_sync().subscribe(function (apiResponse) {
            if (apiResponse['status'] == 'email_updated') {
              if (_this.current_contactid == apiResponse['unique_id']) {
                _this.toastr.success("Email Address Updated Successfully");
              }
            } else if (apiResponse['status'] == 'fname_updated') {
              if (_this.current_contactid == apiResponse['unique_id']) {
                _this.toastr.success("First Name Updated Successfully");
              }
            } else if (apiResponse['status'] == 'lname_updated') {
              if (_this.current_contactid == apiResponse['unique_id']) {
                _this.toastr.success("Last Name Updated Successfully");
              }
            } else if (apiResponse['status'] == 'home_phone_updated') {
              if (_this.current_contactid == apiResponse['unique_id']) {
                _this.toastr.success("Home Phone Number Updated Successfully");
              }
            } else if (apiResponse['status'] == 'mobile_phone_updated') {
              if (_this.current_contactid == apiResponse['unique_id']) {
                _this.toastr.success("Mobile Phone Number Updated Successfully");
              }
            } else {
              if (apiResponse['data'] != '') {
                var cntr = 0;
                ...
                try {
                  for (var _iterator2 = whole_data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var single_contact = _step2.value;
                    cntr++;
                    _this.Contacts = [].concat(_toConsumableArray(_this.Contacts), [{
                      counter: _this.counter,
                      ...
                      c_image_url: _this.default_image_url,
                ...
                _this.toastr.success('Contacts Imported Successfully!!!');
              }
            }
          });
        };

        this.get_perticular_contact_details = function (contact_id) {
          _this.current_contactid = contact_id;

          _this.socket_service.get_current_contact_info(contact_id).subscribe(function (apiResponse) {
            if (apiResponse['status'] == 200) {
              _this.particular_issue_info = {
      ...
      _createClass(ContactComponent, [{
        ...
        value: function ngOnInit() {
          ...
          dbx.filesGetThumbnail({
            "path": "/contact_Manage/empty_avatar.jpg",
            format: {
              '.tag': 'jpeg'
            },
            size: {
          ...
          var getdefault_image_url = function getdefault_image_url(fileUrl) {
            _this2.default_image_url = fileUrl;

            _this2.getAllContacts(_this2.default_image_url);
        ...
        key: "field_mouse_hover",
        value: function field_mouse_hover(edit_icon, input_box_class) {
          var data = "." + input_box_class;
        ...
        key: "field_mouse_out",
        value: function field_mouse_out(edit_icon, input_box_class) {
          var data2 = "." + input_box_class;
        ...
        key: "open_ok_cancel_btn",
        value: function open_ok_cancel_btn(hover_field, click_field, ok_cancel_btn, edit_icon) {
        ...
        key: "remove_field",
        value: function remove_field(clecked_field_name, ok_cancel_btn, hover_field, click_field) {
        ...
        value: function update_email_address() {
          var updated_data = {
        ...
        key: "update_fname",
        value: function update_fname() {
          var updated_fname_data = {
        ...
        key: "update_lname",
        value: function update_lname() {
          var updated_lname_data = {
        ...
        key: "update_home_phone",
        value: function update_home_phone() {
          var updated_home_phone = {
        ...
        key: "update_mobile_phone",
        value: function update_mobile_phone() {
          var updated_mobile_phone = {
    ...
    ContactComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/contact/contact.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./contact.component.css */
      "./src/app/dashboard/contact/contact.component.css")).default]
    })], ContactComponent);
    /***/
  },
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_SafePipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/SafePipe */
    "./src/app/SafePipe.ts");
    /* harmony import */


    var _pariculat_contacts_pariculat_contacts_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./pariculat-contacts/pariculat-contacts.component */
    ...
    DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_6__["Ng2SearchPipeModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([{
        path: 'Dashboard',
        component: _contact_contact_component__WEBPACK_IMPORTED_MODULE_5__["ContactComponent"]
      }, {
        path: 'Contact/:ContactId',
        component: _pariculat_contacts_pariculat_contacts_component__WEBPACK_IMPORTED_MODULE_8__["PariculatContactsComponent"]
      }])]
    })], DashboardModule);
    /***/
  },
  ...
  /***/
  function srcAppDashboardPariculatContactsPariculatContactsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDashboardPariculatContactsPariculatContactsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PariculatContactsComponent", function () {
      return PariculatContactsComponent;
    });
    /* harmony import */
    ...
    var dropbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! dropbox */
    "./node_modules/dropbox/dist/Dropbox-sdk.min.js");
    /* harmony import */


    var dropbox__WEBPACK_IMPORTED_MODULE_4___default =
    /*#__PURE__*/
    __webpack_require__.n(dropbox__WEBPACK_IMPORTED_MODULE_4__);
    /* harmony import */
    ...
    var dbx = new dropbox__WEBPACK_IMPORTED_MODULE_4__["Dropbox"]({
      accessToken: '8OFJNocMFEAAAAAAAAAAhPJetJappwjmhdqNUT5izThN7PRcKdTA27CM6kt3-r_n',
      fetch: fetch
    });

    var PariculatContactsComponent =
    /*#__PURE__*/
    function () {
      function PariculatContactsComponent(activated_route, domSanitizer, _router, socket_service) {
        var _this3 = this;

        _classCallCheck(this, PariculatContactsComponent);
        ...
        this.getAllContacts = function (default_image_url_passed) {
          ...
          _this3.socket_service.get_all_contacts().subscribe(function (apiResponse) {
            var _iteratorNormalCompletion3 = true;
            var _didIteratorError3 = false;
            var _iteratorError3 = undefined;

            try {
              for (var _iterator3 = apiResponse['data'][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var x_contacts = _step3.value;
                _this3.counter++;
                _this3.Contacts = [].concat(_toConsumableArray(_this3.Contacts), [{
                  counter: _this3.counter,
                  contactId: x_contacts['contactId'],
                  email_address: x_contacts['email_address'],
                  related_name: x_contacts['related_name'],
                  home_address_2: x_contacts['home_address_2'],
        ...
        this.get_contacts_from_all_users = function () {
          _this3.socket_service.get_all_contacts_sync().subscribe(function (apiResponse) {
            if (apiResponse != '') {
              ...
              try {
                for (var _iterator4 = apiResponse[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                  var single_contact = _step4.value;
                  _this3.Contacts = [].concat(_toConsumableArray(_this3.Contacts), [{
                    counter: _this3.counter,
                    ...
                    business_state: single_contact['Business State'],
                    image_name: single_contact['image'],
                    c_image_url: _this3.default_image_url,
                    fullname: single_contact['First Name'] + " " + single_contact['Last Name']
                  }]);
                }
              } catch (err) {
      ...
      _createClass(PariculatContactsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this4 = this;
          ...
          this.activated_route.params.subscribe(function (params) {
            _this4.current_contactid = params['ContactId'];
          });
          dbx.filesGetThumbnail({
            "path": "/contact_Manage/empty_avatar.jpg",
            format: {
          ...
          var getdefault_image_url = function getdefault_image_url(fileUrl) {
            _this4.default_image_url = fileUrl;

            _this4.getAllContacts(_this4.default_image_url);

            _this4.scrollToElement(_this4.current_contactid);
          };
    ...
    PariculatContactsComponent.ctorParameters = function () {
      return [{
    ...
    PariculatContactsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-pariculat-contacts',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./pariculat-contacts.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/pariculat-contacts/pariculat-contacts.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./pariculat-contacts.component.css */
      "./src/app/dashboard/pariculat-contacts/pariculat-contacts.component.css")).default]
  ...
  /***/
  function srcAppSocketContactServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SocketContactService", function () {
      return SocketContactService;
    });
    /* harmony import */
    ...
    var SocketContactService = function SocketContactService(_http) {
      var _this5 = this;
      ...
      this.import_contacts = function (import_contacts_data) {
        ...
        _this5.socket.emit("unique_contact_id", import_contacts_data);
      };

      this.get_all_contacts = function () {
        var response = _this5._http.get("".concat(_this5.ContactUrl, "/view_all_contacts"));

        return response;
      };

      this.update_contact_email_address = function (data_to_update) {
        _this5.socket.emit("update_email_address", data_to_update);
      };

      this.update_contact_fname = function (data_to_update) {
        _this5.socket.emit("update_fname", data_to_update);
      };

      this.update_contact_lname = function (data_to_update) {
        _this5.socket.emit("update_lname", data_to_update);
      };

      this.update_home_phone = function (data_to_update) {
        _this5.socket.emit("update_home_phone", data_to_update);
      };

      this.update_mobile_phone = function (data_to_update) {
        _this5.socket.emit("update_mobile_phone", data_to_update);
      };

      this.get_all_contacts_sync = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].create(function (observer) {
          _this5.socket.on('import-contacts', function (data) {
            observer.next(data);
          }); // end Socket
      ...
      this.get_current_contact_info = function (contactid) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('contactId', contactid);

        var response = _this5._http.post("".concat(_this5.ContactUrl, "/Contact_info"), params);

        return response;
      };

      this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_3__["connect"](this.baseUrl, {
        transports: ['websocket'],
        secure: true
      });
    };

    SocketContactService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    SocketContactService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\intouch\frontend\front\src\main.ts */
    "./src/main.ts");
    /***/
  },
